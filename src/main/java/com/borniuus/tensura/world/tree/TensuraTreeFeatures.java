...
public class TensuraTreeFeatures {
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SAKURA_BEEHIVE = FeatureUtils.register("sakura_bee", Feature.TREE,
        basicTreeWithHive(TensuraBlocks.SAKURA_LOG, TensuraBlocks.SAKURA_LEAVES));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SAKURA_LARGE = FeatureUtils.register("sakura_large", Feature.TREE,
        largeTree(TensuraBlocks.SAKURA_LOG, TensuraBlocks.SAKURA_LEAVES));
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SAKURA_LARGE_BEEHIVE = FeatureUtils.register("sakura_large_bee", Feature.TREE,
        largeTreeWithHive(TensuraBlocks.SAKURA_LOG, TensuraBlocks.SAKURA_LEAVES));

    public static final Holder<ConfiguredFeature<RandomFeatureConfiguration, ?>> SAKURA_FOREST = FeatureUtils.register("sakura_forest", Feature.RANDOM_SELECTOR,
        new RandomFeatureConfiguration(List.of(
            new WeightedPlacedFeature(TensuraTreePlacements.SAKURA_LARGE_CHECKED, 0.15F)),
            TensuraTreePlacements.SAKURA_CHECKED));
